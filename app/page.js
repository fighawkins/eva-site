...
const Home = () => (
  <div className="flex justify-center items-center text-center">
    <div className="w-3/5 lg:w-1/3 h-3/5    relative opacity-80">
      <img
        src="/image3.png"
        alt="Image"
        className="w-full h-full object-cover"
      />
      <h1 className="absolute top-0  transform  -translate-y-10 lg:pl-8 text-2xl text-center pl-12 lg:pl-24 lg:text-7xl lg:-translate-y-0 text-black lg:pt-12">
