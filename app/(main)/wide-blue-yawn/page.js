...
const WideBlueYawn = () => {
  return (
    <div className="flex flex-col p-6 md:p-8 items-center justify-center ">
      ...
      <div className="w-full flex flex-col items-center md:w-3/5 mx-auto text-center mt-6">
        <h2 className="text-base mb-10 lg:text-2xl text-black">Wide Blue Yawn (2023)
</h2>
        ...
        <h3 className="text-lg  center font-bold mt-8 mb-8 text-blue-300">Previous Screenings</h3>
